...
namespace Estudio.Models
{
    public class EstudioContext : DbContext
    {
        ...
        // 
        // System.Data.Entity.Database.SetInitializer(new System.Data.Entity.DropCreateDatabaseIfModelChanges<Estudio.Models.EstudioContext>());

        public EstudioContext() : base("name=EstudioContext")
        {
        }
